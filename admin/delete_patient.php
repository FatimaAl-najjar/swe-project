...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['patientIDToDelete'])) {
    ...
    $patient = Admin::findPatient($patientIDToDelete);
    ...
    if ($patient) {
        ...
        echo "Patient with ID $patientIDToDelete doesn't exist ";
    }
}
?>
...
<div id="todelete" class="card">
    <form id="deleteForm" action="" method="post">
        ...
        <input type="text" name="patientIDToDelete" placeholder="Enter patient's ID"><br>
